...
<nav className="flex flex-col h-[calc(100vh-4rem)] w-16 min-h-[400px] border-r border-gray-200 px-2 py-4 shrink-0 gap-4 md:flex-row md:w-64 xl:w-80/60 2xl:w-96/60 border-gray-200 dark:border-gray-800">
  ...
  <div className="flex-1 flex flex-col justify-between min-h-0">
    <div className="flex-1 grid flex-auto min-h-0 shrink-0 items-start gap-4">
      <a
        className="inline-flex h-9 w-max items-center justify-center rounded-md bg-gray-100 px-4 py-2 text-sm font-medium transition-colors hover:bg-gray-100/50 focus:bg-gray-100/50 focus:outline-none"
        href="#"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <a
        className="inline-flex h-9 w-max items-center justify-center rounded-md bg-white px-4 py-2 text-sm font-medium transition-colors hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:text-gray-900 focus:outline-none data-[active]:bg-gray-100/50 dark:data-[active]:bg-gray-800/50"
        href="#"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
